# face detection for the dataset
import os
...
def extract_face(filename, detector, required_size=(160,160)):
	...
	try:
		...
		print("No face detected for {}. Marking for deletion...".format(filename))
    ...
    # resize pixels to the detector size
...
def markForDeletion(filename):
	...
	os.rename(filename, pathName + "/(delete)" + name )
